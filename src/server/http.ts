...
const russianErrorMessages: Record<string, string> = {
  ...
  "Received good quantity must be zero or greater.": "Количество без повреждений не может быть отрицательным.",
  "Received damaged quantity must be zero or greater.": "Количество повреждённого товара не может быть отрицательным.",
  ...
  "Short receiving close requires a note.": "Для закрытия с недопоставкой укажите причину.",
